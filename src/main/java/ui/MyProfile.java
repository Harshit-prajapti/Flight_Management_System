...
public class MyProfile extends javax.swing.JPanel {
    ...
    public MyProfile(MainFrame mainframe,AdminPanel admin) {
        this.admin = admin;
    ...
    private void initComponents() {
        ...
        bookingBtn.setBackground(new java.awt.Color(0, 102, 102));
        bookingBtn.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
